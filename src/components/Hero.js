    ...
    <div className='text-white' >
        <div className='max-w-[800px] flex flex-col w-full text-center mt-[196px] h-screen mx-auto'>
            ...
            <div className='flex justify-center'>
                ...
                <ReactTyped  className='text-xl md:text-5xl sm:text-4xl  font-bold pl-2 text-gray-400 md:pl-4' strings={['BTB','BTC','SASS']}
                 typeSpeed={120} 
                 backSpeed={140} 
                 loop />
            ...
            <p className='md:2xl text:xl font-light text-gray-500 pt-5'>Monitor your data analytics to increase revenue for BTB,BTC,SASS platforms.</p>
